...
Από την έκδοση 2.14 οι ολοκληρωμένες μεταφορές δεν εμφανίζονται στη λίστα διαθέσιμων, οι ληγμένες αιτήσεις επισημαίνονται ως ανεπιτυχείς και υποστηρίζεται προβολή διαδρομών με κόστος μικρότερο ή ίσο.
