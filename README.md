...
## Τελευταία 10 commits
- Συγχώνευση PR #1779 που ενσωματώνει χάρτη στην ανασκόπηση PoI.
  Παρέχει άμεση οπτική αναφορά κατά την αξιολόγηση σημείων.
- Ενσωμάτωση χάρτη στην οθόνη ανασκόπησης PoI.
  Ο χρήστης βλέπει τη θέση χωρίς να απομακρύνεται από την οθόνη.
- Συγχώνευση PR #1778 για επέκταση ελέγχου διπλών διαδρομών.
  Εντοπίζει περισσότερες περιπτώσεις επαναλαμβανόμενων πορειών.
- Διεύρυνση του ελέγχου για διπλές διαδρομές.
  Προλαμβάνει την καταχώρηση πανομοιότυπων πορειών.
- Συγχώνευση PR #1777 που προσθέτει εικονίδιο αυτοκινήτου στην επιλογή διπλής διαδρομής.
  Η λειτουργία είναι πλέον πιο αναγνωρίσιμη στον χρήστη.
- Αντικατάσταση κειμένου με εικονίδιο αυτοκινήτου στο κουμπί διπλής διαδρομής.
  Βελτιώνει την κατανόηση και την αισθητική της διεπαφής.
- Συγχώνευση PR #1776 με εμφάνιση χάρτη κατά την επιλογή PoI στον έλεγχο ονομάτων.
  Επιτρέπει ακριβέστερη επιλογή σημείων μέσω οπτικής επισκόπησης.
- Άνοιγμα χάρτη για επιλογή διπλών σημείων.
  Ο χρήστης εντοπίζει και επιλέγει σημεία με μεγαλύτερη ασφάλεια.
- Συγχώνευση PR #1775 για στρογγυλεμένες ενέργειες στην αναθεώρηση διαδρομής.
  Προσθέτει πιο μοντέρνα και συνεπή αισθητική στα κουμπιά.
- Χρήση στρογγυλών κουμπιών στην οθόνη αναθεώρησης διαδρομής.
  Βελτιώνει την εργονομία και την εμφάνιση των ενεργειών.

Από την έκδοση  1.0 – Πρώτη κυκλοφορία της εφαρμογής με βασική λειτουργικότητα και αρχική διαμόρφωση του build.gradle.kts όπου ορίζεται versionName = "1.0" και versionCode = 1\
...
Από την έκδοση 2.20 ενσωματώνεται χάρτης στην ανασκόπηση PoI, επεκτείνεται ο έλεγχος διπλών διαδρομών και στρογγυλοποιούνται τα κουμπιά αναθεώρησης.
