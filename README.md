...
Από την έκδοση 2.20 προστέθηκε χάρτης και μετονομασία διαδρομών, καθώς και φόρτωση λεπτομερειών κρατήσεων από Firestore.
Η ανασκόπηση ονόματος δείχνει όλες τις διαδρομές και αιτήσεις με οδηγό αποφεύγοντας διπλές αποθηκεύσεις όταν δεν αλλάζουν στάσεις.
Υιοθετήθηκε KSP, εμπλουτίστηκε η εκτύπωση εισιτηρίων και διορθώθηκαν διάφορα σφάλματα χάρτη.
