...
Τα δέκα τελευταία commits ολοκλήρωσαν τις ειδοποιήσεις οδηγών για νέα αιτήματα μεταφοράς και έκαναν ομοιόμορφη την εμφάνιση των διαδρομών.
Ενισχύθηκε ο συγχρονισμός δεδομένων ώστε να αποφεύγονται διπλότυπες ή ελλιπείς εγγραφές στη Room και στο Firestore.
Παράλληλα σταθεροποιήθηκαν οι διάλογοι επιλογής χρόνου στο UI, προσφέροντας πιο αξιόπιστη διαδικασία κράτησης.
...
Από την έκδοση 2.25 οι ειδοποιήσεις οδηγών για αιτήματα μεταφοράς λειτουργούν ομοιόμορφα και οι διαδρομές εμφανίζουν καθαρά ονόματα και στάσεις.
