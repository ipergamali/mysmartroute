...
### Σύνοψη τελευταίων commits

Τα τελευταία 10 commits επεκτείνουν την αναζήτηση οχημάτων, εμφανίζοντας μαζί τοπικές και απομακρυσμένες διαδρομές και προσθέτοντας ετικέτες για διπλότυπες ομάδες.
Παράλληλα διορθώνονται οι αναφορές `routeId` στο Firestore ώστε να φορτώνονται σωστά όλες οι διαδρομές και ενεργοποιείται πλήρης κύλιση στην ανασκόπηση.
Περιλαμβάνονται επίσης ενημέρωση τεκμηρίωσης και συγχώνευση με το `master` για να παραμείνει συνεπής ο κώδικας.
