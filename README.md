...
## Περιγραφή των 10 τελευταίων commits

- `379524f`: Περιορισμός των διαδρομών λεωφορείων σε οχήματα λεωφορείων (#1678).
- `988f1fa`: Περιορισμός των διαδρομών λεωφορείων σε οχήματα λεωφορείων.
- `3285550`: Διόρθωση επιλογέα ημερομηνίας (#1677).
- `c902003`: Διόρθωση επιλογέα ημερομηνίας.
- `81b61db`: Περιορισμός παλαιών ημερομηνιών στις ανακοινώσεις μεταφοράς.
- `0c68856`: Αφαίρεση ημερομηνίας από την αναζήτηση οχήματος βάσει κόστους (#1668).
- `b4ba9d9`: Αφαίρεση πεδίου ημερομηνίας από την αναζήτηση οχήματος βάσει κόστους.
- `ec6050f`: Προσθήκη αποθήκευσης στάσεων λεωφορείου στις διαδρομές (#1666).
- `a91e2ec`: Συγχώνευση του branch `master` στο `codex/add-bus_stations-subcollection-and-table`.
- `6ee1e2a`: Αυτόματη αποθήκευση στάσεων λεωφορείου.
